...
def download_image(image_url, save_path, image_name, timeout=5):
    try:
...
needed_classes = [1, 16, 17, 18, 19, 22, 23, 24, 27, 29, 30, 31, 36, 37, 38, 39, 40, 41, 42, 43]
needed_classes_counts = {1: 364, 16: 451, 17: 459, 18: 295, 19: 126, 22: 268, 23: 156, 24: 332, 27: 283, 29: 385, 30: 236, 31: 113, 36: 475, 37: 499, 38: 271, 39: 426, 40: 476, 41: 104, 42: 293, 43: 285}

img_count = 150000
save_path = "./data/eccv_val_images/"
os.makedirs(save_path, exist_ok=True)  # Create folder if it doesn't exist
download_json_file = "data/eccv_train.json"


csv_file_path = 'data/labels_eccv_train_more_low_classes.csv'
