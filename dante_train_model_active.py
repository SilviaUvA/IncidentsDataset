...
def main():
    ...
    model_save_dir = "models/active_select_1000_epoch20/"
    result_folder = "results/active_select_1000_epoch20/"
    eval_csv_file = "data/perma_eval_labels.csv"
    active_all_used_train_samples = "results/active_select_1000_epoch20/active_save_train_samples.csv"
